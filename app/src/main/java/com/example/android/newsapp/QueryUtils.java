...
class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> newsstoryList = extractFeatureFromJson(jsonResponse);
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        List<News> newsstoryList = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                News news = new News(title, authorName, webUrl);
                newsstoryList.add(news);
            }
